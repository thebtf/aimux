...
func (s *Server) handleGuidePrompt(_ context.Context, _ mcp.GetPromptRequest) (*mcp.GetPromptResult, error) {
	...
	sb.WriteString("| Route code, review, or spec work | task | task_class, prompt, target |\n")
	sb.WriteString("| Review code through the dedicated facade | review | prompt, target, gate |\n")
	sb.WriteString("| Draft specifications through the dedicated facade | spec | prompt, target |\n")
